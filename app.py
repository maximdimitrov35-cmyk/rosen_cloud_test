...
for message_index, message in enumerate(
    ...
    with st.chat_message(
        ...
        elif message.get("type") == "screenshots":
...
chat_input = st.chat_input(
    "Message Росен or attach screenshots",
...
if user_message or uploaded_files:
    ...
    if not user_message and uploaded_files:
        user_message = "Please analyze the attached screenshot(s)."
    ...
    # The screenshot bytes stay in the active Streamlit session.
    # Firestore stores the text message, not raw screenshot bytes.
    ...
    try:
        ...
        if uploaded_files:
            ...
            with st.chat_message(
                ...
                with st.spinner(
                    "Росен is looking at your screenshot..."
                ):
